...
/**
 * Computed win-probability estimate from the match situation (resources: balls, wickets,
 * required vs current rate). A simple model — like ESPN's Win Probability — NOT betting odds.
 * Shown only for a limited-overs chase, where the situation is well-defined.
 */
